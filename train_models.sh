...
for model in $Models; do
    echo Training $model
    python research/object_detection/model_main_tf2.py --pipeline_config_path="${model}_pipeline_file.config" --model_dir=training_$model --alsologtostderr --num_train_steps=4000 --sample_1_of_n_eval_examples=1 --num_eval_steps=100
done
